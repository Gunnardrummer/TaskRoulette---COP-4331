/*
  background.js:    Used to resize the background on login and signup pages. 
                    When you resize the browser, then image will automatically adjust.
  By:               Jess
*/
